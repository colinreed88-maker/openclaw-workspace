...
export const sendEmailDef = {
    name: "send_email",
    description: "Send an email via Resend. IMPORTANT: Show the full draft (to, subject, body) to the user first. Only call this tool after the user explicitly approves (e.g. 'send it', 'approved', 'go ahead'). Domain-restricted to allowed email domains.",
    parameters: {
        type: "object",
        properties: {
