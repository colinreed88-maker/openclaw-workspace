...
export const definition = {
  ...
  description:
    "Manage scheduled tasks (cron jobs). Actions: 'list' to see all tasks, 'create' to add a new one, 'update' to modify, 'delete' to remove, 'enable'/'disable' to toggle. IMPORTANT: For create/update/delete, show the details to the user first and only call after explicit approval.",
  parameters: {
    type: "object",
    properties: {
      action: {
