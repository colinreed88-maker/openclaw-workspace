...
export const definition = {
    ...
    description: "Read a file from the Flow codebase on GitHub. Use to understand how pages work, how data is structured, what queries or filters a page uses, or how APIs are implemented. Available repos: flow-intranet, flow-ai-worker, openclaw-workspace.",
    parameters: {
        type: "object",
        properties: {
            repo: {
                type: "string",
                description: "Repository name: 'flow-intranet', 'flow-ai-worker', or 'openclaw-workspace'",
            },
            path: {
                type: "string",
...
export async function execute(_id, params) {
    ...
    const allowedRepos = ["flow-intranet", "flow-ai-worker", "openclaw-workspace"];
